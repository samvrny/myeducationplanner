<template>
  <main class="main-content flex flex-column align-center">
    ...
    <section class="this-week path-box text-center colored-tab">
      ...
      <p><span class="bold">Saturday 7/15:</span>Work at the Tavern at 10:45 ❌ Go on the beer patio crawl with the boys ❌ Get ahold of Bruce about start date ❌</p>
      <p><span class="bold">Sunday 7/16:</span>Relax and recover ❌ Drive back to Viroqua ❌ Pack things for Viroqua, grab sport equipment ❌</p>
      <p><span class="bold">Monday 7/17:</span>Work landscaping job ❌ Work on Wordpress for 1 hour. ❌ Work on Microsoft Office for 1 hour ❌</p>
