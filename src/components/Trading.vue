<template>
    <div class="mt-20 w-full">
        <section class="trading-accounts w-3/6 inline-block text-center">
            ...
            <a class="mt-4 block" href="https://www.coinbase.com/trade" target="_blank"><button class="mx-6 mt-6 text-xl bg-purple-800 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded w-52">Coinbase</button></a>
        ...
        <section class="trading-charts w-3/6 inline-block text-center align-top">
            ...
            <a class="mt-4 block" href="https://docs.google.com/document/d/106-WAokogAjsSK790icOXY1hzGjozE-cp5PMz9C41N0/edit?usp=sharing" target="_blank"><button class="mx-6 mt-2 text-xl bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded w-52">Trading Notes</button></a>
        </section>
    </div>
</template>